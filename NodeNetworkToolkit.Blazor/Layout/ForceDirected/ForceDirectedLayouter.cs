...
public sealed class ForceDirectedLayouter {
  ...
  /// <summary>
  /// Compatibility API equivalent of NodeNetworkToolkit's synchronous force-directed layout.
  /// </summary>
  ...
  /// <summary>
  /// Compatibility API equivalent of NodeNetworkToolkit's asynchronous layout simulation.
  /// </summary>
