...
public class NetworkViewModel : ReactiveObject {
  ...
  public NetworkViewModel() {
    ...
    Nodes.Preview().OnItemRemoved(removedNode => {
      ...
      var pendingConnectionInvalid = PendingConnection?.Input?.Parent == removedNode ||
  ...
  /// </summary>
  public void StartCut() => CutLine.IsVisible = true;
  ...
  /// </summary>
  public void RemovePendingConnection() => PendingConnection = null;
  ...
  /// </summary>
  public void FinishRectangleSelection() => SelectionRectangle.IsVisible = false;
}
