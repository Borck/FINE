...
public class PortView : Control, IViewFor<PortViewModel> {
  ...
  public Brush RegularStroke {
    get => (Brush)GetValue(RegularStrokeProperty);
    set => SetValue(RegularStrokeProperty, value);
  }
  ...
  public Brush RegularFill {
    get => (Brush)GetValue(RegularFillProperty);
    set => SetValue(RegularFillProperty, value);
  }
  ...
  public Brush ConnectedStroke {
    get => (Brush)GetValue(ConnectedStrokeProperty);
    set => SetValue(ConnectedStrokeProperty, value);
  }
  ...
  public Brush ConnectedFill {
    get => (Brush)GetValue(ConnectedFillProperty);
    set => SetValue(ConnectedFillProperty, value);
  }
  ...
  public Brush ErrorStroke {
    get => (Brush)GetValue(ErrorStrokeProperty);
  ...
  public Brush ErrorFill {
    get => (Brush)GetValue(ErrorFillProperty);
    set => SetValue(ErrorFillProperty, value);
  }
  ...
  public PortView() {
    DefaultStyleKey = typeof(PortView);
  }
  ...
  protected virtual void SetupLayoutEvent() => this.WhenActivated(d => {
    Observable.FromEventPattern<EventHandler, EventArgs>(
            ...
            .Subscribe(e => {
              ...
              var networkView = WPFUtils.FindParent<NetworkView>(this);
              if (networkView == null) {
                return;
              }
              ...
              var transform = TransformToAncestor(networkView.contentContainer);
