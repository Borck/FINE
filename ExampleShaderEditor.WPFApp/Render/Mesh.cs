...
public class Mesh : IDisposable {
  public static Mesh LoadMesh(float[] vertexPositions, float[] textureCoordinates, float[] normals, int[] faceIndices) {
    ...
    var textureCoordinatesBuffer = Int32.MaxValue;
    ...
    var normalsBufferId = Int32.MaxValue;
    if (normals.Length != 0) {
    ...
    var indicesBufferId = GL.GenBuffer();
  ...
  public void Dispose() => GL.DeleteVertexArrays(1, new[] { VertexArrayObjectId });
}
