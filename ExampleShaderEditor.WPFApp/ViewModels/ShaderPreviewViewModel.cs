...
public class ShaderPreviewViewModel : ReactiveObject {
  ...
  public ShaderPreviewViewModel() {
    ...
    VertexShaderSource = ReadResource("FINE.Resources.Shaders.vertex.glsl");
    FragmentShaderSource = ReadResource("FINE.Resources.Shaders.fragment.glsl");
  }

  private string[] ReadResource(string path) {
    using (var stream = typeof(ShaderPreviewViewModel).Assembly.GetManifestResourceStream(path))
