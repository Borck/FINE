...
public class NetworkValidationTests {
  ...
  public void TestConstantToOutput() => ImmediateScheduler.Instance.With(_ => {
    ...
    var constantNode = new ConstantNodeViewModel();
  ...
  public void TestDivideToOutput() => ImmediateScheduler.Instance.With(_ => {
    ...
    var divisionNode = new DivisionNodeViewModel();
  ...
  public void TestProductRecursively() => ImmediateScheduler.Instance.With(_ => {
    ...
    var productNodeA = new ProductNodeViewModel();
    ...
    var productNodeB = new ProductNodeViewModel();
  ...
  public void TestLongChain() => new TestScheduler().With(_ => {
    ...
    var productNode = new ProductNodeViewModel();
    main.NetworkViewModel.Nodes.Add(productNode);

    var divisionNode = new DivisionNodeViewModel();
    main.NetworkViewModel.Nodes.Add(divisionNode);

    var subtractionNode = new SubtractionNodeViewModel();
    main.NetworkViewModel.Nodes.Add(subtractionNode);

    var sumNode = new SumNodeViewModel();
