...
/// </summary>
public sealed class DefaultNodeNetworkCompatibilityAdapter : INodeNetworkCompatibilityAdapter
{
    public NodeNetworkDocument Export(NetworkModel network)
    {
        return new NodeNetworkDocument
        {
    ...
    public NetworkModel Import(NodeNetworkDocument document)
    {
    ...
    private static PortDocument ToDocument(NodePortModel port)
    {
    ...
    private static NodePortModel FromDocument(Guid nodeId, PortDocument port, PortDirection fallbackDirection)
    {
