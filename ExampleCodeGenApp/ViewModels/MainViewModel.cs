...
public class MainViewModel : ReactiveObject {
  ...
  public MainViewModel() {
    ...
    var eventNode = new ButtonEventNode { CanBeRemovedByUser = false };
    ...
    var isGroupNodeSelected = this.WhenAnyValue(vm => vm.Network)
        ...
        .Switch()
        .Select(_ => Network.SelectedNodes.Count == 1 && Network.SelectedNodes.Items[0] is GroupNodeViewModel);

    UngroupNodes = ReactiveCommand.Create(() => {
      var selectedGroupNode = (GroupNodeViewModel)Network.SelectedNodes.Items[0];
